 ...
 *
 * The length is Reference::COLUMN_LENGTH rather than the 15 a generated
 * `ENR-2026-000042` needs. Rows are inserted carrying a UUID placeholder that
 * is replaced with the real reference inside the same transaction (design
 * section 2), and a UUID is 36 characters; the constant holds either with room
 * for a prefixed placeholder, while keeping step 3's unique index small.
 */
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('enrollments', function (Blueprint $table): void {
            $table->string('reference', Reference::COLUMN_LENGTH)->nullable();
        });
    }
